...
pub enum MigrationInstruction {
    ...
    #[account(6, name="delegate_record", desc="Update authority or delegate")]
    #[account(7, name="token_record", desc="Update authority or delegate")]
    #[account(8, writable, name="migration_state", desc = "The migration state account")]
    #[account(9, name="program_signer", desc="Program signer PDA")]
    ...
    #[account(15, name="token_metadata_program", desc = "Token Metadata program for the CPI call")]
