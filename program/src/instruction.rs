...
pub enum MigrationInstruction {
    ...
    #[account(1, name="item_mint", desc="Mint account")]
    #[account(2, writable, name="item_metadata", desc="Metadata account")]
    #[account(3, name="item_edition", desc="Edition account")]
    #[account(4, writable, name="item_token", desc="Token account")]
    #[account(5, name="token_owner", desc="Token owner")]
    #[account(6, name="token_owner_program,", desc="Program that owns the token owner")]
    #[account(7, name="token_owner_program_buffer,", desc="Executable buffer account of the program owner")]
    #[account(8, name="collection_metadata", desc="Collection metadata account")]
    #[account(9, name="delegate_record", desc="Update authority or delegate")]
    #[account(10, writable, name="token_record", desc="Update authority or delegate")]
    #[account(11, writable, name="migration_state", desc = "The migration state account")]
    #[account(12, name="program_signer", desc="Program signer PDA")]
    #[account(13, name="system_program", desc="System program")]
    #[account(14, name="sysvar_instructions", desc="Instruction sysvar account")]
    #[account(15, name="spl_token_program", desc="Token Program")]
